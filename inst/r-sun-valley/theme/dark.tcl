...
namespace eval ttk::theme::sun-valley-dark {
    ...
    ttk::style theme create sun-valley-dark -parent clam -settings {
        ...
        ttk::style configure TLabel -foreground $colors(-fg)
        ...
        ttk::style configure TCheckbutton -foreground $colors(-fg)
        ttk::style configure TRadiobutton -background $colors(-bg)
        ttk::style configure TRadiobutton -foreground $colors(-fg)
        ttk::style configure TScale -background $colors(-bg)
        ttk::style configure TProgressbar -background $colors(-bg)
        ttk::style configure TNotebook.Tab -foreground $colors(-fg)
        ttk::style configure TMenubutton -foreground $colors(-fg)
